...
export default function Login() {
    ...
    function signIn() {
        ...
        axios
            .post(`http://65.0.74.234:8989/signIn/${email}/${pass}`,)
            .then(({ data }) => {
    ...
    return (
        <>
            ...
            <div className="modal fade" id="login" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button className="btn btn-primary" onClick={() => { signIn() }} data-bs-dismiss="modal">LogIn</button>
                        </div>
                    </div>
                </div>
            </div>
